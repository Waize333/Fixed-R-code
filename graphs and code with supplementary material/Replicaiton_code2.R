...
data_raw_football <- rio::import("D:/Rcode/gaa_results_football.xlsx") %>% 
  mutate(sport = "Gaelic Football")

data_raw_hurling <- rio::import("D:/Rcode/gaa_results_hurling.xlsx") %>% 
...
## Figure 1 ----
ggplot(data = boot_home_advantage, aes(x = sport...8, 
